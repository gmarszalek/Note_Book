...
void __fastcall TForm1::N1Click(TObject *Sender)
{
    if (OpenDialog1 ->Execute())
     ...
     nazwapliku = OpenDialog1->FileName;
       ...
       ShowMessage("B³¹d otwarcia pliku, upenwij siê, ¿e plik istnieje na syku");
...
{
   if(Application->MessageBox("Czy na pewno zakoñczyc program?", "Potwierdz" ,
...
void __fastcall TForm1::WytnijCtrV1Click(TObject *Sender)
{
   tresc->CutToClipboard();        
}
//---------------------------------------------------------------------------

void __fastcall TForm1::KopjujCtrC1Click(TObject *Sender)
{
...
void __fastcall TForm1::Zapraszamnamojastrone1Click(TObject *Sender)
{
